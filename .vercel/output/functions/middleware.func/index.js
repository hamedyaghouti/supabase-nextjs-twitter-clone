...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* binding */ next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fmiddleware_ts_page_2Fmiddleware_rootDir_2FUsers_2Fhamedyaghouti_2FDesktop_2FProjects_2Flearning_2Fsupabase_2Fsupabase_nextjs_twitter_clone_matchers_preferredRegion_middlewareConfig_e30_3D_)
});
...
function clearPreviewData(res, options = {}) {
    ...
    const { serialize } = __webpack_require__(9104);
...
var async_local_storage = __webpack_require__(4092);
...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fmiddleware.ts&page=%2Fmiddleware&rootDir=%2FUsers%2Fhamedyaghouti%2FDesktop%2FProjects%2Flearning%2Fsupabase%2Fsupabase-nextjs-twitter-clone&matchers=&preferredRegion=&middlewareConfig=e30%3D!
        ...
        /* harmony default export */ function next_middleware_loaderabsolutePagePath_private_next_root_dir_2Fmiddleware_ts_page_2Fmiddleware_rootDir_2FUsers_2Fhamedyaghouti_2FDesktop_2FProjects_2Flearning_2Fsupabase_2Fsupabase_nextjs_twitter_clone_matchers_preferredRegion_middlewareConfig_e30_3D_(opts) {
          return adapter({
            ...opts,
            page: "/middleware",
            handler,
...
var import_auth_helpers_shared = __webpack_require__(3303);
var supabase;
function createClientComponentClient({ supabaseUrl = "https://oqetnmealraxzvlallio.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9xZXRubWVhbHJheHp2bGFsbGlvIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTY5NDQ0NjAsImV4cCI6MjAxMjUyMDQ2MH0.1om7AKUt0r4O2eNzrf3AMdc49VsLSlu5u2K2Qx7MTyc", options, cookieOptions, isSingleton = true } = {}) {
...
var import_auth_helpers_shared2 = __webpack_require__(3303);
var import_set_cookie_parser = __webpack_require__(8870);
...
function createPagesServerClient(context, { supabaseUrl = "https://oqetnmealraxzvlallio.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9xZXRubWVhbHJheHp2bGFsbGlvIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTY5NDQ0NjAsImV4cCI6MjAxMjUyMDQ2MH0.1om7AKUt0r4O2eNzrf3AMdc49VsLSlu5u2K2Qx7MTyc", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared3 = __webpack_require__(3303);
var import_set_cookie_parser2 = __webpack_require__(8870);
...
function createMiddlewareClient(context, { supabaseUrl = "https://oqetnmealraxzvlallio.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9xZXRubWVhbHJheHp2bGFsbGlvIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTY5NDQ0NjAsImV4cCI6MjAxMjUyMDQ2MH0.1om7AKUt0r4O2eNzrf3AMdc49VsLSlu5u2K2Qx7MTyc", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared4 = __webpack_require__(3303);
...
function createServerComponentClient(context, { supabaseUrl = "https://oqetnmealraxzvlallio.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9xZXRubWVhbHJheHp2bGFsbGlvIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTY5NDQ0NjAsImV4cCI6MjAxMjUyMDQ2MH0.1om7AKUt0r4O2eNzrf3AMdc49VsLSlu5u2K2Qx7MTyc", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
var import_auth_helpers_shared5 = __webpack_require__(3303);
...
function createRouteHandlerClient(context, { supabaseUrl = "https://oqetnmealraxzvlallio.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9xZXRubWVhbHJheHp2bGFsbGlvIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTY5NDQ0NjAsImV4cCI6MjAxMjUyMDQ2MH0.1om7AKUt0r4O2eNzrf3AMdc49VsLSlu5u2K2Qx7MTyc", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
// src/deprecated.ts
function createBrowserSupabaseClient({ supabaseUrl = "https://oqetnmealraxzvlallio.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9xZXRubWVhbHJheHp2bGFsbGlvIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTY5NDQ0NjAsImV4cCI6MjAxMjUyMDQ2MH0.1om7AKUt0r4O2eNzrf3AMdc49VsLSlu5u2K2Qx7MTyc", options, cookieOptions } = {}) {
...
function createServerSupabaseClient(context, { supabaseUrl = "https://oqetnmealraxzvlallio.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9xZXRubWVhbHJheHp2bGFsbGlvIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTY5NDQ0NjAsImV4cCI6MjAxMjUyMDQ2MH0.1om7AKUt0r4O2eNzrf3AMdc49VsLSlu5u2K2Qx7MTyc", options, cookieOptions } = {}) {
...
function createMiddlewareSupabaseClient(context, { supabaseUrl = "https://oqetnmealraxzvlallio.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9xZXRubWVhbHJheHp2bGFsbGlvIiwicm9sZSI6ImFub24iLCJpYXQiOjE2OTY5NDQ0NjAsImV4cCI6MjAxMjUyMDQ2MH0.1om7AKUt0r4O2eNzrf3AMdc49VsLSlu5u2K2Qx7MTyc", options, cookieOptions } = {}) {
...
if (typeof globalThis === "object") {
    ...
    try {
        _globalThis = __webpack_require__(2286);
    } catch (error) {} finally{
...
module.exports = __webpack_require__(8512).version;
...
const resolveFetch = (customFetch)=>{
    ...
    if (customFetch) {
        ...
        _fetch = (...args)=>Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 4466, 23)).then(({ default: fetch1 })=>fetch1(...args));
    } else {
        _fetch = fetch;
    }
...
var browser = __webpack_require__(4466);
...
const version = "1.8.5"; //# sourceMappingURL=version.js.map
...
var lib_browser = __webpack_require__(6782);
;// CONCATENATED MODULE: ./node_modules/@supabase/realtime-js/dist/module/lib/version.js
const version_version = "2.8.0"; //# sourceMappingURL=version.js.map
...
class RealtimeClient {
     ...
     */ constructor(endPoint, options){
        ...
        this.transport = lib_browser.w3cwebsocket;
...
const resolveResponse = ()=>helpers_awaiter(void 0, void 0, void 0, function*() {
        if (typeof Response === "undefined") {
            // @ts-ignore
            return (yield Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 4466, 23))).Response;
        }
        return Response;
...
const lib_version_version = "2.5.4"; //# sourceMappingURL=version.js.map
...
const module_lib_version_version = "2.38.1"; //# sourceMappingURL=version.js.map
...
async function fetch_handleError(error) {
    ...
    throw new AuthApiError(fetch_getErrorMessage(data), error.status || 500);
}
...
// Generated by genversion.
const dist_module_lib_version_version = "2.55.0"; //# sourceMappingURL=version.js.map
...
;// CONCATENATED MODULE: ./node_modules/@supabase/gotrue-js/dist/module/lib/locks.js
...
class NavigatorLockAcquireTimeoutError extends (/* unused pure expression or super */ null && (LockAcquireTimeoutError)) {
}
/**
...
//# sourceMappingURL=middleware.js.map;
  export default (function () {
    ...
    {"name":"middleware","staticRoutes":[{"page":"/","regex":"^/(?:/)?$","routeKeys":{},"namedRegex":"^/(?:/)?$"},{"page":"/_not-found","regex":"^/_not\\-found(?:/)?$","routeKeys":{},"namedRegex":"^/_not\\-found(?:/)?$"},{"page":"/favicon.ico","regex":"^/favicon\\.ico(?:/)?$","routeKeys":{},"namedRegex":"^/favicon\\.ico(?:/)?$"},{"page":"/tweets","regex":"^/tweets(?:/)?$","routeKeys":{},"namedRegex":"^/tweets(?:/)?$"}],"dynamicRoutes":[],"nextConfig":{"basePath":""}}
  )